      ...
      <Stack.Navigator initialRouteName={isLoggedIn ? PATHS.HOME : PATHS.MAIN}>
        {!isLoggedIn ? (
          ...
          <>
            ...
            <Stack.Screen name={PATHS.MATH_OPERATIONS} component={MathOperations} options={{ headerTitle: t("screens.math") }} />
            <Stack.Screen name={PATHS.SUM} component={Sum} options={{ headerTitle: t("mathOperations.sum") }} />
            <Stack.Screen name={PATHS.DIFF} component={Difference} options={{ headerTitle: t("mathOperations.diff") }} />
            <Stack.Screen name={PATHS.MULT_CHECK} component={MultiplicationCheck} options={{ headerTitle: t("mathOperations.multCheck") }}/>
            <Stack.Screen name={PATHS.MULT} component={Multiplication} options={{ headerTitle: t("mathOperations.multiplication") }} />
            <Stack.Screen name={PATHS.MULT_DIGIT} component={MultiplicationNumber} options={{ headerTitle: t("mathOperations.multBy") }} />
            <Stack.Screen name={PATHS.MULT_NULLS} component={MultiplicationNulls} options={{ headerTitle: t("mathOperations.multNulls") }} />
            <Stack.Screen name={PATHS.EQUATIONS} component={Equations} options={{ headerTitle: t("mathOperations.equations") }} />
            <Stack.Screen name={PATHS.EQUATIONS_X} component={EquationsWithX} options={{ headerTitle: t("mathOperations.equationsWithX") }}  />
